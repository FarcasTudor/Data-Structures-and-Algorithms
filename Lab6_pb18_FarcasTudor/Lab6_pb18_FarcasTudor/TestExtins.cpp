...
void testAllExtins() {
	testCerintaLAB();
	cout << "Test cerinta LAB passed!\n";
	testCreeaza();
	cout << "Test creeaza passed!\n";
	testAdauga();
	cout << "Test adauga passed!\n";
	testSterge();
	cout << "Test sterge passed!\n";
	testIterator();
